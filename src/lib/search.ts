...
const tokenAliases: Record<string, string[]> = {
  ...
  base: ["claim", "palisade", "cabin", "storage"],
  safe: ["claim", "palisade", "protect"],
  secure: ["palisade", "claim", "protect"],
  defense: ["palisade", "wall", "claim"],
  wall: ["palisade", "fence"],
  fence: ["palisade", "wall"],
  land: ["claim", "base"],
  private: ["claim"],
  river: ["boat", "water", "cross"],
  lake: ["boat", "water", "cross"],
  water: ["boat", "river", "lake"],
  mining: ["mine", "ore", "metal"],
  mine: ["mining", "ore", "metal"],
  ore: ["mine", "mining", "metal"],
  metal: ["mine", "mining", "ore"],
  hide: ["leather", "tanning"],
  hides: ["leather", "tanning"],
  tan: ["leather", "tanning"],
  tanning: ["leather", "hide"],
  crops: ["crop", "farm", "farming"],
  crop: ["farm", "farming", "seed"],
  farm: ["farming", "crop", "seed"],
  storage: ["cupboard", "store", "container"],
  store: ["storage", "cupboard", "container"],
  hauling: ["cart", "haul", "move"],
  haul: ["cart", "move", "transport"],
  cook: ["fireplace", "food"],
  cooking: ["fireplace", "food"],
};
